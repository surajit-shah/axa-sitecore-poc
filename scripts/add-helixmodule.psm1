...
$projectModuleType = "Project"										# Used in Add-Project and Create-Config.                               
...
<#
    .SYNOPSIS
    Adds a Sitecore Helix Project module to the current solution.
    ...
    .PARAMETER Name
    The name of the new Project module, excluding the namespace prefix since that comes from the json config file.
