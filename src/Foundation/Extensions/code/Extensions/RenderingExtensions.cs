namespace Mirabeau.Foundation.Extensions.Extensions
{
    using System;
    using Sitecore;
    ...
    public static class RenderingExtensions
    {
        ...
        {
            return MainUtil.GetBool(rendering.Parameters[Mirabeau.Foundation.Extensions.Constants.DynamicPlaceholdersLayoutParameters.UseStaticPlaceholderNames], false);
        }
    }
}